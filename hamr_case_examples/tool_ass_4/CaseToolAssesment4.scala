...
object CaseToolAssesment4 extends App {
  ...
  val case_tool_evaluation_dir: Os.Path = Os.home / "devel/hamr-case-examples/case/tool-assessment-4"

  var experimentalOptions: ISZ[String] = ISZ(ExperimentalOptions.GENERATE_DOT_GRAPHS)

  val nonVmProjects: ISZ[Project] = ISZ(

    gen("basic/test_data_port_periodic_domains", "base", ISZ(linux, sel4), ISZ(
      "hamr/c/ext-c/consumer_thread_i_consumer_consumer/consumer_thread_i_consumer_consumer.c",
      "hamr/c/ext-c/producer_thread_i_producer_producer/producer_thread_i_producer_producer.c")),

    gen("basic/test_event_data_port_periodic_domains", "base", ISZ(linux, sel4), ISZ(
    ...
    gen("basic/test_event_port_periodic_domains", "base", ISZ(linux, sel4), ISZ(
      "hamr/c/ext-c/consumer_t_i_consumer_consumer/consumer_t_i_consumer_consumer.c",
      "hamr/c/ext-c/producer_t_i_producer_producer/producer_t_i_producer_producer.c")),

    gen("basic/tutorial", "base", ISZ(linux, sel4), ISZ(
      "hamr/c/ext-c/consumer_t_i_consumer_consumer/consumer_t_i_consumer_consumer.c",
      "hamr/c/ext-c/producer_t_i_producer_producer/producer_t_i_producer_producer.c")),

    gen("bit-codec/producer-filter-consumer", "pfc", ISZ(linux, sel4), ISZ(
      "hamr/c/ext-c/consumer_t_consumer_consumer/consumer_t_consumer_consumer.c",
      "hamr/c/ext-c/filter_t_filter_filter/filter_t_filter_filter.c",
      "hamr/c/ext-c/producer_t_producer_producer/producer_t_producer_producer.c",
      "hamr/slang/src/main/component/pfc/TranspilerToucher.scala",
      "hamr/slang/src/main/data/pfc/PFC/MissionBitCodec.scala",
      "hamr/c/ext-c/ext.c",
      "hamr/c/ext-c/ext.h")),

    gen("cakeml/attestation-gate", "attestation-gate", ISZ(linux, sel4), ISZ(
      "hamr/c/ext-c/CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate/CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate.c",
      "hamr/c/ext-c/RadioDriver_thr_Impl_radio_RadioDriver/RadioDriver_thr_Impl_radio_RadioDriver.c",
      "hamr/c/ext-c/UxAS_thr_Impl_uxas_UxAS_thread/UxAS_thr_Impl_uxas_UxAS_thread.c",
      "hamr/camkes/components/CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate/src/.gitignore")),
  )
  ...
  def run(): Unit = {
    ...
    for (project <- tests) {
      ...
      val hamrDir = project.rootDir / "hamr"
      hamrDir.removeAll()
  ...
  def genFull(path: String, basePackageName: String, platforms: ISZ[Cli.SireumHamrCodegenHamrPlatform.Type], shouldSimulate: B, timeout: Z, gitReplacements: ISZ[String]): Project = {
    ...
    return Project(basePackageName, rootDir, aadlDir, hamrDir, json, options, shouldSimulate, timeout, gitReplacements)
  }

  def gen(path: String, basePackageName: String, platforms: ISZ[Cli.SireumHamrCodegenHamrPlatform.Type], gitReplacements: ISZ[String]): Project = {
    return genFull(path, basePackageName, platforms, T, defTimeout, gitReplacements)
  }

  def genVM(shouldSim: B, path: String, basePackageName: String, platforms: ISZ[Cli.SireumHamrCodegenHamrPlatform.Type], gitReplacements: ISZ[String]): Project = {
    return genFull(path, basePackageName, platforms, shouldSim, vmTimeout, gitReplacements)
  }
}